...
const (
	...
	ExitErrDNS        = 5 // ExitErrDNS indicates DNS host resolution or MX query failure.
	...
	ExitErrSend       = 8 // ExitErrSend indicates SMTP payload transmission error.
	ExitErrConnection = 9 // ExitErrConnection indicates TCP connection failure (timeout, refused, unreachable).
)
